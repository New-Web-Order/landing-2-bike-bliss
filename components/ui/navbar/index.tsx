...
const Navbar = () => {
  ...
  return (
    <>
      <Disclosure as="nav" className="bg-primary-1200 lg:flex lg:items-center lg:h-20 border-b border-bg-900 py-3 lg:py-0 ">
        {({ open }) => (
          <>
            <div className="mx-auto w-full max-w-screen-2xl px-3.5 lg:px-6 ">
              <div className="relative flex items-center justify-between">
                ...
                >
                  ...
                  />
                  <p className="font-bold text-2xl text-bg-100 ">{data.navbar.logoText}</p>
                      ...
                      <a key={item.name} href={item.href}>
                        <p
                          className={classNames(
                            "px-4 text-[15px] font-semibold leading-[1.219rem] text-bg-100 hover:text-primary-300",
                          )}
